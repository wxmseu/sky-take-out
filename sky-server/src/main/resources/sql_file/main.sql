...
CREATE TABLE `address_book` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE utf8mb4_unicode_ci COMMENT='地址簿';
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4  COMMENT='菜品';
...
CREATE TABLE `dish_flavor` (
                               ...
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4  COMMENT='菜品口味关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4  COMMENT='员工信息';
...
CREATE TABLE `order_detail` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4  COMMENT='订单明细表';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4  COMMENT='套餐';
...
CREATE TABLE `setmeal_dish` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4  COMMENT='套餐菜品关系';
